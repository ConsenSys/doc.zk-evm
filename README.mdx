...
1. Navigate to the root folder of the project after installing Node.js
...
You can run other linters for code style (CSS, JavaScript) and link formatting at any time with the 
