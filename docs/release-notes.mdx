...
- Adjust blob submission and finalization events to state reconstruction-compatible
   ...
   * @param startBlockNumber The indexed L2 block number indicating which block the finalization of the data starts from.
...
<details>
  <summary>Learn more about EIP-4844</summary>
    ...
    Conversely, blobs have their own fee market, completely separate from the regular gas fee market on 
...
Contracts audit is in progress. This doesn't reflect the final versions.
